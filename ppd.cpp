    ...
    while (!exitLoop)
    {
        ...
        else if (choice == "2")
        {
            ...
            if (itemstock.get(item_id))
            {
                ...
                if (centz.empty()) //checks for empty input(enter or ctrl d)
                {
                    to_menu = true;
                }
                else
                {
                    while (!invalid)
                    {
                        ...
                        {
                            std::cout << "Error wrong format of currency" << std::endl;
                            std::getline(std::cin, centz);
                        }
                    }

                    while (!coinstock.newCoin(cents)) // checks if the user has entered a valid denomination of currency
                    {
            ...
            if (!to_menu)
            {
                itm->on_hand--; // reduces the quantity of the item purchased 
        ...
        // if input is 3 then save and exit
        else if (choice == "3")
        {
        ...
        // if input is 4 then add an item to the 
        else if (choice == "4")
        {
